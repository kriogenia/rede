...
pub enum ParsingError {
    ...
    #[diagnostic(
        code("spec violation"),
        url("https://rede.sotoestevez.dev/reference_guide/request_dsl.html"),
    ...
    #[diagnostic(
        ...
        url("https://rede.sotoestevez.dev/reference_guide/errors.html#invalid-request"),
...
pub enum RequestError<E: Error> {
    #[error(transparent)]
    #[diagnostic(
        code = "failed request building",
        url = "https://rede.sotoestevez.dev/reference_guide/errors.html#failed-request-building"
    )]
    Building(E),
    #[error(transparent)]
    #[diagnostic(
        code = "failed connection",
        url = "https://rede.sotoestevez.dev/reference_guide/errors.html#failed-connection"
    )]
    FailedConnection(E),
    #[error("resulting url is not correct ({})", style(url).underlined().cyan())]
    #[diagnostic(
        code = "invalid url",
        url = "https://rede.sotoestevez.dev/reference_guide/errors.html#invalid-url"
    )]
    InvalidUrl {
        url: String,
    ...
    #[diagnostic(
        code = "invalid file",
        url = "https://rede.sotoestevez.dev/reference_guide/errors.html#invalid-file",
        help(
    ...
    #[diagnostic(
        code = "redirect",
        url = "https://rede.sotoestevez.dev/reference_guide/errors.html#redirect"
    )]
    Redirect(E),
    #[error(transparent)]
    ...
    #[diagnostic(
        ...
        url = "https://rede.sotoestevez.dev/reference_guide/errors.html#wrong-http-version",
